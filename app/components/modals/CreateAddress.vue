						...
						<div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
							...
							<div class="flex flex-col gap-1.5">
								...
								<div class="relative" v-click-outside="() => cityOpen = false">
									<div
										class="flex items-center h-10 rounded-xl border bg-gray-50 focus-within:bg-white transition-all px-3 gap-2 cursor-pointer"
...
const { isOpenModal } = defineProps({ isOpenModal: false });
