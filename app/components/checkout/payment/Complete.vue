<template>
	<div class="bg-white border border-gray-100 rounded-2xl overflow-hidden">
		<!-- Top accent bar -->
		<div
			class="h-1 bg-gradient-to-r from-green-400 via-emerald-500 to-green-400"
		/>
		...
		<div class="px-6 py-8 flex flex-col items-center text-center">
			...
			<div class="relative mb-6">
				...
				>
					<div
						class="w-14 h-14 rounded-full bg-green-500 flex items-center justify-center shadow-lg shadow-green-500/30"
					>
				...
				<!-- Pulse ring -->
				<div
					class="absolute inset-0 rounded-full bg-green-400/20 animate-ping"
				/>
			</div>
			...
			<!-- Order ID badge -->
			<div
				class="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-gray-50 border border-gray-200 mb-6"
			>
				<Icon
				...
				<span
					class="text-sm font-black text-gray-800 tracking-wide font-mono"
				...
				<div class="flex flex-col gap-0">
					...
					>
						<div class="flex flex-col items-center">
							...
							<div
								v-if="i < nextSteps.length - 1"
								class="w-px h-6 bg-gray-200 mt-0.5"
							/>
						</div>
						<div class="pb-3 pt-1 text-left">
							<p
								class="text-xs font-bold"
								:class="i === 0 ? 'text-gray-800' : 'text-gray-400'"
							>
								{{ step.title }}
							</p>
		...
		<!-- Footer strip -->
		<div
			class="px-6 py-3 border-t border-gray-100 bg-gray-50/60 flex items-center justify-center"
		>
			<NuxtLink
				to="/common/contact-us"
				class="flex items-center gap-1.5 text-[11px] text-gray-400 font-medium hover:text-primary transition-colors"
			>
...
const nextSteps = [
	{
		...
		desc: "We've received your order and payment confirmation.",
	},
	{
		icon: "mdi:package-variant-closed",
		title: "Being Prepared",
		desc: "Your items are being packed at our warehouse.",
	},
	{
		icon: "mdi:truck-fast-outline",
		title: "Out for Delivery",
		desc: "Your order will be shipped to your address soon.",
	},
	{
		icon: "mdi:map-marker-check-outline",
		title: "Delivered",
		desc: "Sit back and wait for your order to arrive!",
	},
];
